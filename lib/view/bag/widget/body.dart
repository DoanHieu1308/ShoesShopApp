                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                ...
                                Text("${currentBagItem.numberSelected.toString()}", style: AppThemes.bagProductNumOfShoe),
                                SizedBox(
                                  width: 10,
                                ),
                                GestureDetector(
                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            SizedBox(height: 5,),
                            Text("${currentBagItem.sizeShoes.country}",style: TextStyle(fontWeight: FontWeight.bold),),
                            SizedBox(height: 5,),
                            Text("${currentBagItem.sizeShoes.sizeShoes.toString()}",style: TextStyle(fontWeight: FontWeight.bold)),
                          ],
                        ),
                      )
                    ],
